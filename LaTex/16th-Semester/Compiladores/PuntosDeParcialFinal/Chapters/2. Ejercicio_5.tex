...
\textbf{Justificación:} La producción $S$ consume cualquier prefijo (ruido) hasta encontrar el primer patrón obligatorio $ab$, momento en el cual transiciona a $F$. El no terminal $F$ permite generar repeticiones adicionales del patrón o terminar la cadena con $\epsilon$, asegurando así la condición de una o más repeticiones \cite{crespi2019formal}.
...
\[ (a|b)^* ab (a|b)^* \]
Sin embargo, para capturar \textbf{cada} ocurrencia de $ab$ como pide la traducción (y no solo la primera), refinamos la expresión conceptualmente como: "Prefijo irrelevante, seguido de grupos de (patrón o ruido)".
...
\]
Esta estructura asegura que el primer $ab$ se traduce, y cualquier $ab$ subsecuente (mezclado con ruido) también se traduce a $X$.
