...
\newcommand\reporttitle{Análisis Financiero Proyecto Sanna}
...
\textbf{Group Number: C2566-OG0261-3473}
}

% Insert authors and student numbers here
\newcommand\reportauthors{
Esteban Castro Rodriguez \\
Juan Pablo Giraldo Ramirez \\
David Ruiz Echeverri \\
Santiago Casas Taborda \\
Juan Manuel Young Hoyos
}

% Add the name of your tutor (for DBL) or any other text.
\newcommand\grouptutor{
Tutor: Felipe Mosquera Muñoz
}
