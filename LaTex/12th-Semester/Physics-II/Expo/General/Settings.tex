...
\newcommand\reportsubtitle{
    Física II - C2366-DF0239-5267 (2023-II)
}

% Add your group number (for DBL) or any other text.
\newcommand\groupnumber{
    \textbf{Grupo Viernes 8-10}
}

% Insert authors and student numbers here
\newcommand\reportauthors{
    Victor Daniel Arango Sohm & vdarangos@eafit.edu.co \\
    Miguel Adrián Pulido Marín & mapulidom1@eafit.edu.co \\
    Amelia Hoyos Velez & ahoyosv2@eafit.edu.co \\
    Juan Manuel Young Hoyos & jmyoungh@eafit.edu.co\\
    Sara Zuluaga Trujillo & szuluagat@eafit.edu.co \\
}

% Add the name of your tutor (for DBL) or any other text.
\newcommand\grouptutor{
    Profesor: Guillermo Alberto Palacio Cardenas
}
